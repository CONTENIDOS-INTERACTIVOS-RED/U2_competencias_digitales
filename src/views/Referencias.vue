...
.curso-main-container.referencias
  BannerInterno.text-uppercase(icono="fas fa-book" subTitulo="Referencias bibliográficas" titulo="Unidad 2. Competencias de autoformación y autogestión del aprendizaje")
